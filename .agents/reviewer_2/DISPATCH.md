...
You are Reviewer 2 conducting an independent audit of work unit `inv-addy-4`.
Your working directory is `/Users/peterkloss/Dev/ACMElabs/brain-v2/.agents/reviewer_2/`.
...
7. Write your review report to `/Users/peterkloss/Dev/ACMElabs/brain-v2/.agents/reviewer_2/handoff.md` with an explicit verdict: `APPROVE` or `REQUEST_CHANGES` (with reasons). Send a message when done.
