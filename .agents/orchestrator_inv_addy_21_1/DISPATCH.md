...
You are the Project Orchestrator for work unit `inv-addy-21`.

Your working directory is:
/Users/peterkloss/Dev/ACMElabs/brain-v2/.agents/orchestrator_inv_addy_21_1
...
1. 2 inventory entries in `docs/analysis/inventory/addy/`:
   - `external-idea-refine-md.md` (or exact naming convention per existing entries / METHOD.md)
   - `external-debugging-and-error-recovery-md.md`
