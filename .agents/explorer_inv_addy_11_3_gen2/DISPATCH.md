...
You are Explorer 3 Gen 2 (explorer_inv_addy_11_3_gen2) for work unit inv-addy-11.
Your working directory is: /Users/peterkloss/Dev/ACMElabs/brain-v2/.agents/explorer_inv_addy_11_3_gen2
...
3. Cross-cutting integration analysis across ALL 16 files in inv-addy-11:
   - How `validate-commands.js` validates these TOML commands. Run `bun scripts/validate-commands.js` inside `sources/addy/` to see validation behavior!
...
4. For each assigned file, prepare the exact inventory sections per `docs/plan/templates/inventory-entry.md`:
   ...
   - Observations
   - Context cost
5. Write your full, comprehensive findings to `/Users/peterkloss/Dev/ACMElabs/brain-v2/.agents/explorer_inv_addy_11_3_gen2/handoff.md`.
