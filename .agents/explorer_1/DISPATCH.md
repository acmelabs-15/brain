...
You are Explorer 1 investigating work unit `inv-addy-4` for the lifecycle synthesis project.
Your working directory is `/Users/peterkloss/Dev/ACMElabs/brain-v2/.agents/explorer_1/`.
