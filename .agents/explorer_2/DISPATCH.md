...
<USER_REQUEST>
You are Explorer 2 investigating work unit `inv-addy-4` for the lifecycle synthesis project.
Your working directory is `/Users/peterkloss/Dev/ACMElabs/brain-v2/.agents/explorer_2/`.
...
5. Write your complete analysis and generated inventory entries to `/Users/peterkloss/Dev/ACMElabs/brain-v2/.agents/explorer_2/handoff.md` and send a message when done.
</USER_REQUEST>
