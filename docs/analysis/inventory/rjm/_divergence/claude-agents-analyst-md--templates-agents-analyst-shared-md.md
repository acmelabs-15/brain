...
### Hunk 2 — .claude/agents/analyst.md:55-68 ↔ templates/agents/analyst.shared.md:70-83
- **class:** harness-substitution
- **canonical says:** "- Level 3: External documentation fetched in this session (Context7, DeepWiki MCP)." — .claude/agents/analyst.md:58
...
### Hunk 3 — .claude/agents/analyst.md:116-131 ↔ templates/agents/analyst.shared.md:131-146
- **class:** harness-substitution
- **canonical says:** "| `/pull/<N>` or PR #N | `mcp__github__pull_request_read` | `github.com/org/repo/pull/42` |" — .claude/agents/analyst.md:123
...
### Hunk 4 — .claude/agents/analyst.md:133-157 ↔ templates/agents/analyst.shared.md:148-172
- **class:** harness-substitution
- **canonical says:** "via its declared read-only MCP tools. Do not suggest shell commands for the" — .claude/agents/analyst.md:136
...
### Hunk 5 — .claude/agents/analyst.md:158-171 ↔ templates/agents/analyst.shared.md:173-185
- **class:** content
- **canonical says:** "never" — .claude/agents/analyst.md:161
...
### Hunk 6 — .claude/agents/analyst.md:172-201 ↔ templates/agents/analyst.shared.md:186-210
- **class:** harness-substitution
- **canonical says:** "GitHub read tools (`mcp__github__pull_request_read`, `mcp__github__issue_read`," — .claude/agents/analyst.md:175
...
### Hunk 7 — .claude/agents/analyst.md:199-222 ↔ templates/agents/analyst.shared.md:211-211
- **class:** harness-substitution
- **canonical says:** "## Degraded Mode Protocol" — .claude/agents/analyst.md:202
