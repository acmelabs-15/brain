...
> "display_name: \"Codebase Design\"" — skills/engineering/codebase-design/agents/openai.yaml:2
(first substantive line; no explicit purpose statement)

## Design intent — required
OpenAI / Codex interface metadata configuration for the `codebase-design` skill. Establishes the human-readable display title and concise descriptive summary shown in agent skill listings, identifying it as the shared vocabulary for deep-module design.
