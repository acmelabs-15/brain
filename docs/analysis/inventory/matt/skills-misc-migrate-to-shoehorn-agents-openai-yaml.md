...
Interface metadata for the `migrate-to-shoehorn` skill in OpenAI / Codex agent runtime environments. Configures the display name and brief description for agent tool registries.
...
## Observations
Minimal agent metadata file providing Codex compatibility for the shoehorn migration skill.
