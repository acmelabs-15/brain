...
Interface metadata for the `git-guardrails-claude-code` skill in OpenAI / Codex agent runtime environments. Defines the display title and concise descriptive summary shown in agent skill listings.
...
## Observations
Companion configuration for OpenAI/Codex agent harnesses providing user-facing metadata corresponding to the skill defined in SKILL.md. Unlike some other skills, it does not declare a policy block.
