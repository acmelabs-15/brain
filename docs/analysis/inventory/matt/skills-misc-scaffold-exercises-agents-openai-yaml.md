...
> "short_description: \"Scaffold lint-ready course exercises\"" — skills/misc/scaffold-exercises/agents/openai.yaml:3

## Design intent — required
Declares OpenAI Codex and ChatGPT agent configuration interface metadata for the `scaffold-exercises` skill. Establishes the display title (`Scaffold Exercises`) and a concise summary (`Scaffold lint-ready course exercises`).
...
## Structure
- `interface:` — skills/misc/scaffold-exercises/agents/openai.yaml:1
...
## Context cost
108 bytes (~30 tokens). Interface configuration metadata; negligible context footprint.
