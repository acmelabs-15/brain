...
Interface metadata for the `scaffold-exercises` skill in OpenAI / Codex agent runtime environments. Declares the display title and short description for skill registry listings.
...
## Observations
Standard 4-line companion configuration file for Codex harness compatibility.
