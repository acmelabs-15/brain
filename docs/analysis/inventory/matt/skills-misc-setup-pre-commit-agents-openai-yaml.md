...
Interface metadata for the `setup-pre-commit` skill in OpenAI / Codex agent runtime environments. Sets the display name and brief description for tool discovery.
...
## Observations
Standard 4-line companion configuration file for OpenAI Codex agent integration.
