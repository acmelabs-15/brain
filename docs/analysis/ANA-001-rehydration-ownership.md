...
> Copy of record. Written 2026-08-31 as ANA-001 in env-setup (uncommitted there); this repo's ANA-001 is the one PLAN-001 and ADR-001 cite.

> **Analysis** · 2026-08-31 · status: decided (see § Decisions; sequencing: build in acmelabs-15/sessions, move last) · ADR-001 · session SES-001 (acmelabs-15/sessions, PLAN-001) ·
...
| env-setup `docs/decisions/ADR-001` | supersedes the placement and mode clauses of ADR-019, ADR-020 (leave/close), ADR-022 and ADR-023; the grain (ADR-021) stands |
...
- ADR-001 in `docs/decisions/` (written 2026-08-31, uncommitted with this note).
