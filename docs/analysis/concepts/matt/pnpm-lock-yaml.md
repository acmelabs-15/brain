...
|---|---|---|---|
| skills/misc/setup-pre-commit/SKILL.md | 19 | used here | Inspected to detect pnpm as the repository's active package manager. |
...
## Design notes
Lockfile name for pnpm package manager; recorded as a name-only file identifier rather than an engineering lifecycle concept.
