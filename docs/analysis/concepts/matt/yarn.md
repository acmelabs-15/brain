...
|---|---|---|---|
| skills/misc/setup-pre-commit/SKILL.md | 19 | used here | Identified as the package manager corresponding to yarn.lock. |
...
## Design notes
Yarn package manager CLI tool; recorded as a name-only tool identifier rather than an engineering lifecycle concept.
