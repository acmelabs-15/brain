...
|---|---|---|---|
| skills/misc/setup-pre-commit/SKILL.md | 19 | used here | Inspected to detect Bun as the repository's active package manager. |
...
## Design notes
Binary lockfile name for Bun runtime and package manager; recorded as a name-only file identifier rather than an engineering lifecycle concept.
