...
|---|---|---|---|
| skills/misc/setup-pre-commit/SKILL.md | 19 | used here | Identified as the package manager corresponding to pnpm-lock.yaml. |
...
## Design notes
Fast, disk space efficient package manager CLI tool; recorded as a name-only tool identifier rather than an engineering lifecycle concept.
