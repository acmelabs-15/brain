...
|---|---|---|---|
| skills/misc/setup-pre-commit/SKILL.md | 19 | used here | Identified as the package manager associated with package-lock.json and used as the default fallback. |
...
## Design notes
Default JavaScript package manager and CLI tool; recorded as a name-only tool identifier rather than an engineering lifecycle concept.
