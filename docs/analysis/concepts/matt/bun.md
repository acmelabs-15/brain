...
|---|---|---|---|
| skills/misc/setup-pre-commit/SKILL.md | 19 | used here | Identified as the package manager corresponding to bun.lockb. |
...
## Design notes
All-in-one JavaScript runtime and package manager tool; recorded as a name-only tool identifier rather than an engineering lifecycle concept.
