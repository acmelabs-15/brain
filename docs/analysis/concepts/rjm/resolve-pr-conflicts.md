...
|---|---|---|---|
| .claude/skills/merge-resolver/scripts/resolve_pr_conflicts.py | 686 | defined here | Primary definition of `resolve_pr_conflicts` within resolve_pr_conflicts.py. |
...
## Design notes
An operational technique or artifact (resolve_pr_conflicts) utilized within the rjm ecosystem to ensure consistency and systematic execution.
