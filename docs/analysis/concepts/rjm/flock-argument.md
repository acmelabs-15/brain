...
|---|---|---|---|
| scripts/validation/push_lock_resolver.py | 65 | defined here | Helper function returning the token argument passed to flock within a shell statement, ignoring options and file descriptors. |
