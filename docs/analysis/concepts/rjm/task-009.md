...
## Definition — verbatim
> "- REQ-009, DESIGN-009, TASK-009 (specs in `.agents/specs/`)" — .claude/skills/orphan-ref-validator/SKILL.md:367
...
## Design notes
An operational technique or artifact (TASK-009) utilized within the rjm ecosystem to ensure consistency and systematic execution.
