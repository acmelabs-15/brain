---
package: rjm
name: Skill-Negotiation-005: Bundle; Never Trade One Dimension
slug: skill-negotiation-005-bundle-never-trade-one-dimension
kind: technique
...
|---|---|---|---|
| .claude/skills/negotiation/references/skills.md | 79 | defined here | Primary definition of `Skill-Negotiation-005: Bundle; Never Trade One Dimension` within skills.md. |
...
## Design notes
An operational technique or artifact (Skill-Negotiation-005: Bundle; Never Trade One Dimension) utilized within the rjm ecosystem to ensure consistency and systematic execution.
