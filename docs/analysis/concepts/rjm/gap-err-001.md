...
## Definition — verbatim
(used, not defined)
> "#### GAP-ERR-001: Silent Failure Pattern" — .agents/archive/planning/PR-60/001-pr-60-review-gap-analysis.md:108
...
## Design notes
A defect tracking identifier in PR-60 gap analysis cataloging silent failure suppression via shell || true rather than an independent lifecycle concept.
