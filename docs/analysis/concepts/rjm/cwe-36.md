...
|---|---|---|---|
| .claude/agents/security/references/powershell-security-checklist.md | 42 | used here | Cited in section header for Absolute Path Traversal vulnerability checks. |
| scripts/security/invoke_security_retrospective.py | 360 | used here | High-severity CWE classification in security retrospective analysis. |
...
## Design notes
CWE-36 is a Common Weakness Enumeration identifier for Absolute Path Traversal rather than an operational lifecycle concept.
