...
| .claude/skills/windows-image-updater/SKILL.md | 8 | defined here | Primary definition of `windows-image-updater` within SKILL.md. |
...
## Design notes
An operational technique or artifact (windows-image-updater) utilized within the rjm ecosystem to ensure consistency and systematic execution.
