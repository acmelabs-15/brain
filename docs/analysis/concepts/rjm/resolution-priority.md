...
## Definition — verbatim
> "**Resolution Priority:**" — .claude/skills/merge-resolver/references/strategies.md:71
...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 71 | defined here | Primary definition of `Resolution Priority` within strategies.md. |
...
## Design notes
An operational technique or artifact (Resolution Priority) utilized within the rjm ecosystem to ensure consistency and systematic execution.
