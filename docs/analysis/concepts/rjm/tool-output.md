...
## Design notes
TOOL_OUTPUT is a hook command environment variable representing tool execution output payloads rather than an operational lifecycle concept, classified as name-only per D-023.
