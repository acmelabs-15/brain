...
|---|---|---|---|
| .claude/skills/merge-resolver/SKILL.md | 244 | defined here | Primary definition of `Completion Checklist` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Completion Checklist) utilized within the rjm ecosystem to ensure consistency and systematic execution.
