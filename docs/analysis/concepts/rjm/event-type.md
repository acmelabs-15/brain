...
## Definition — verbatim
> "\"event_type\": {" — .claude/skills/observability/schema.json:17
...
|---|---|---|---|
| .claude/skills/observability/schema.json | 17 | defined here | Primary definition of `event_type` within schema.json. |
...
## Design notes
An operational technique or artifact (event_type) utilized within the rjm ecosystem to ensure consistency and systematic execution.
