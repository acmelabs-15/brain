---
package: rjm
name: resolve_conflicts_worktree
slug: resolve-conflicts-worktree
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/scripts/resolve_pr_conflicts.py | 572 | defined here | Primary definition of `resolve_conflicts_worktree` within resolve_pr_conflicts.py. |
...
## Design notes
An operational technique or artifact (resolve_conflicts_worktree) utilized within the rjm ecosystem to ensure consistency and systematic execution.
