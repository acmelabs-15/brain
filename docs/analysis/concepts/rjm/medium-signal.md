...
|---|---|---|---|
| .claude/skills/panning-for-gold/references/gold-found-template.md | 15 | defined here | Primary definition of `Medium-Signal` within gold-found-template.md. |
| .claude/skills/panning-for-gold/scripts/synthesis.py | 29 | used here | Referenced and applied in synthesis.py during verification and operational workflows. |
...
## Design notes
An operational technique or artifact (Medium-Signal) utilized within the rjm ecosystem to ensure consistency and systematic execution.
