...
|---|---|---|---|
| .claude/skills/planner/references/explainers-and-intents.md | 63 | defined here | Primary definition of `Fast Track` within explainers-and-intents.md. |
...
## Design notes
An operational technique or artifact (Fast Track) utilized within the rjm ecosystem to ensure consistency and systematic execution.
