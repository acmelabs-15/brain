...
|---|---|---|---|
| .claude/skills/planner/references/hybrid-memory-architecture.md | 43 | defined here | Primary definition of `Decision Extraction` within hybrid-memory-architecture.md. |
...
## Design notes
An operational technique or artifact (Decision Extraction) utilized within the rjm ecosystem to ensure consistency and systematic execution.
