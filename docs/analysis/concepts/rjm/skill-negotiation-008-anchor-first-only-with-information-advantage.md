---
package: rjm
name: Skill-Negotiation-008: Anchor First Only With Information Advantage
slug: skill-negotiation-008-anchor-first-only-with-information-advantage
kind: technique
...
|---|---|---|---|
| .claude/skills/negotiation/references/skills.md | 143 | defined here | Primary definition of `Skill-Negotiation-008: Anchor First Only With Information Advantage` within skills.md. |
...
## Design notes
An operational technique or artifact (Skill-Negotiation-008: Anchor First Only With Information Advantage) utilized within the rjm ecosystem to ensure consistency and systematic execution.
