...
|---|---|---|---|
| .claude/skills/planner/resources/default-conventions.md | 16 | defined here | Primary definition of `Severity Levels` within default-conventions.md. |
...
## Design notes
An operational technique or artifact (Severity Levels) utilized within the rjm ecosystem to ensure consistency and systematic execution.
