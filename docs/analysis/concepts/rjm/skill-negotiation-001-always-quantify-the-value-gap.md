---
package: rjm
name: Skill-Negotiation-001: Always Quantify the Value Gap
slug: skill-negotiation-001-always-quantify-the-value-gap
kind: technique
...
|---|---|---|---|
| .claude/skills/negotiation/references/skills.md | 5 | defined here | Primary definition of `Skill-Negotiation-001: Always Quantify the Value Gap` within skills.md. |
...
## Design notes
An operational technique or artifact (Skill-Negotiation-001: Always Quantify the Value Gap) utilized within the rjm ecosystem to ensure consistency and systematic execution.
