---
package: rjm
name: Moved or Renamed Code
slug: moved-or-renamed-code
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 21 | defined here | Primary definition of `Moved or Renamed Code` within strategies.md. |
...
## Design notes
An operational technique or artifact (Moved or Renamed Code) utilized within the rjm ecosystem to ensure consistency and systematic execution.
