...
|---|---|---|---|
| .claude/skills/planner/resources/default-conventions.md | 72 | defined here | Primary definition of `Testing Conventions` within default-conventions.md. |
...
## Design notes
An operational technique or artifact (Testing Conventions) utilized within the rjm ecosystem to ensure consistency and systematic execution.
