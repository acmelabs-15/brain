---
package: rjm
name: Additive Changes
slug: additive-changes
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 5 | defined here | Primary definition of `Additive Changes` within strategies.md. |
...
## Design notes
An operational technique or artifact (Additive Changes) utilized within the rjm ecosystem to ensure consistency and systematic execution.
