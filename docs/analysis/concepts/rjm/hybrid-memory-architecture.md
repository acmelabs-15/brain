...
slug: hybrid-memory-architecture
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/references/hybrid-memory-architecture.md | 7 | defined here | Primary definition of `Hybrid Memory Architecture` within hybrid-memory-architecture.md. |
...
## Design notes
An operational technique or artifact (Hybrid Memory Architecture) utilized within the rjm ecosystem to ensure consistency and systematic execution.
