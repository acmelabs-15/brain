...
|---|---|---|---|
| .claude/skills/observability/references/otel-semantic-conventions.md | 39 | defined here | Primary definition of `Attribute Namespaces` within otel-semantic-conventions.md. |
...
## Design notes
An operational technique or artifact (Attribute Namespaces) utilized within the rjm ecosystem to ensure consistency and systematic execution.
