...
## Definition — verbatim
> "| Decision           | Reasoning Chain                                              |" — .claude/skills/planner/resources/plan-format.md:19
...
|---|---|---|---|
| .claude/skills/planner/resources/plan-format.md | 19 | defined here | Primary definition of `Reasoning Chain` within plan-format.md. |
...
## Design notes
An operational technique or artifact (Reasoning Chain) utilized within the rjm ecosystem to ensure consistency and systematic execution.
