---
package: rjm
name: Skill-Negotiation-006: Model Tier Routing for Negotiation Tasks
slug: skill-negotiation-006-model-tier-routing-for-negotiation-tasks
kind: technique
...
|---|---|---|---|
| .claude/skills/negotiation/references/skills.md | 96 | defined here | Primary definition of `Skill-Negotiation-006: Model Tier Routing for Negotiation Tasks` within skills.md. |
...
## Design notes
An operational technique or artifact (Skill-Negotiation-006: Model Tier Routing for Negotiation Tasks) utilized within the rjm ecosystem to ensure consistency and systematic execution.
