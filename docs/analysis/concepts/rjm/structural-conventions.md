...
|---|---|---|---|
| .claude/skills/planner/resources/default-conventions.md | 25 | defined here | Primary definition of `Structural Conventions` within default-conventions.md. |
...
## Design notes
An operational technique or artifact (Structural Conventions) utilized within the rjm ecosystem to ensure consistency and systematic execution.
