...
|---|---|---|---|
| .claude/skills/merge-resolver/SKILL.md | 85 | defined here | Primary definition of `Intent Classification` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Intent Classification) utilized within the rjm ecosystem to ensure consistency and systematic execution.
