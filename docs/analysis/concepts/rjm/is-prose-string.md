---
package: rjm
name: _is_prose_string
slug: is-prose-string
kind: name-only
package_phase: none
...
|---|---|---|---|
| scripts/validation/check_vendor_portability.py | 373 | defined here | Helper function identifying multi-line templates and sentence-like prose strings exempt from path enforcement. |
