...
|---|---|---|---|
| .claude/skills/planner/resources/plan-format.md | 46 | defined here | Primary definition of `Constraints & Assumptions` within plan-format.md. |
...
## Design notes
An operational technique or artifact (Constraints & Assumptions) utilized within the rjm ecosystem to ensure consistency and systematic execution.
