---
package: rjm
name: Configuration File Conflicts
slug: configuration-file-conflicts
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 102 | defined here | Primary definition of `Configuration File Conflicts` within strategies.md. |
...
## Design notes
An operational technique or artifact (Configuration File Conflicts) utilized within the rjm ecosystem to ensure consistency and systematic execution.
