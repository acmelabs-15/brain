...
slug: python-security-extended-qls
kind: name-only
package_phase: none
...
|---|---|---|---|
| .claude/skills/security-scan/SKILL.md | 19 | used here | CodeQL query suite file cited as the authoritative runner for Python security scanning in CI. |
...
## Design notes
python-security-extended.qls is a CodeQL query suite specification file identifier used for Python static analysis in CI rather than an operational lifecycle concept.
