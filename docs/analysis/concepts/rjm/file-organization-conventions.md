---
package: rjm
name: File Organization Conventions
slug: file-organization-conventions
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/resources/default-conventions.md | 56 | defined here | Primary definition of `File Organization Conventions` within default-conventions.md. |
...
## Design notes
An operational technique or artifact (File Organization Conventions) utilized within the rjm ecosystem to ensure consistency and systematic execution.
