...
> "SKILL_SIZE_LIMIT: int = 500" — scripts/validation/skill_size.py:61
...
|---|---|---|---|
| scripts/validation/skill_size.py | 61 | defined here | Sets the maximum line threshold (500 lines) permitted for any SKILL.md prompt file. |
