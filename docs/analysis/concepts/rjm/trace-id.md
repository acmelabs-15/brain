...
## Definition — verbatim
> "\"trace_id\": {" — .claude/skills/observability/schema.json:37
...
|---|---|---|---|
| .claude/skills/observability/schema.json | 37 | defined here | Primary definition of `trace_id` within schema.json. |
...
## Design notes
An operational technique or artifact (trace_id) utilized within the rjm ecosystem to ensure consistency and systematic execution.
