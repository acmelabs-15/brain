...
> "_HELPER_FUNCTIONS: frozenset[str] = frozenset(" — scripts/validation/check_vendor_portability.py:124
...
|---|---|---|---|
| scripts/validation/check_vendor_portability.py | 124 | defined here | Constant frozenset of portable path helper function names exposed by `.claude/lib/paths.py`. |
