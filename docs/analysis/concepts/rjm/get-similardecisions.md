---
package: rjm
name: Get-SimilarDecisions
slug: get-similardecisions
kind: name-only
package_phase: none
...
# Get-SimilarDecisions

## Definition — verbatim
(used, not defined)
> "Get-SimilarDecisions -Context" — .agents/architecture/ADR-038-reflexion-memory-schema.md:187
...
|---|---|---|---|
| .agents/architecture/ADR-038-reflexion-memory-schema.md | 187 | defined here | Proposed PowerShell query cmdlet signature for finding similar decisions given a context string |
