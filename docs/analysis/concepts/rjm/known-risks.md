...
|---|---|---|---|
| .claude/skills/planner/resources/plan-format.md | 53 | defined here | Primary definition of `Known Risks` within plan-format.md. |
| .claude/skills/planner/scripts/planner.py | 60 | defined here | Primary definition of `Known Risks` within planner.py. |
...
## Design notes
An operational technique or artifact (Known Risks) utilized within the rjm ecosystem to ensure consistency and systematic execution.
