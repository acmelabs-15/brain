...
> "def tree_entries(" — scripts/validation/portability_git.py:130
...
|---|---|---|---|
| scripts/validation/portability_git.py | 130 | defined here | Function listing entries of a committed tree-ish via git ls-tree with --full-tree. |
