---
package: rjm
name: Stable Versus Experimental
slug: stable-versus-experimental
kind: technique
...
|---|---|---|---|
| .claude/skills/observability/references/otel-semantic-conventions.md | 48 | defined here | Primary definition of `Stable Versus Experimental` within otel-semantic-conventions.md. |
...
## Design notes
An operational technique or artifact (Stable Versus Experimental) utilized within the rjm ecosystem to ensure consistency and systematic execution.
