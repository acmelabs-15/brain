...
## Definition — verbatim
> "\"tool_call\"," — .claude/skills/observability/schema.json:20
...
|---|---|---|---|
| .claude/skills/observability/schema.json | 20 | defined here | Primary definition of `tool_call` within schema.json. |
| .claude/skills/observability/SKILL.md | 49 | defined here | Primary definition of `tool_call` within SKILL.md. |
...
## Design notes
An operational technique or artifact (tool_call) utilized within the rjm ecosystem to ensure consistency and systematic execution.
