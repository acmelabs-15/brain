...
|---|---|---|---|
| .claude/skills/negotiation/SKILL.md | 56 | defined here | Primary definition of `Phase 4: Assess` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Phase 4: Assess) utilized within the rjm ecosystem to ensure consistency and systematic execution.
