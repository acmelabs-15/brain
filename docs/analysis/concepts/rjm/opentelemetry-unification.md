---
package: rjm
name: OpenTelemetry Unification
slug: opentelemetry-unification
kind: technique
...
|---|---|---|---|
| .claude/skills/observability/references/three-pillars-reference.md | 74 | defined here | Primary definition of `OpenTelemetry Unification` within three-pillars-reference.md. |
...
## Design notes
An operational technique or artifact (OpenTelemetry Unification) utilized within the rjm ecosystem to ensure consistency and systematic execution.
