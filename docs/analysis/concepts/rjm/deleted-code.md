...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 42 | defined here | Primary definition of `Deleted Code` within strategies.md. |
...
## Design notes
An operational technique or artifact (Deleted Code) utilized within the rjm ecosystem to ensure consistency and systematic execution.
