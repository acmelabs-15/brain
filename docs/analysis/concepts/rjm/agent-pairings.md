...
> "Enables multi-agent workflow design." — .agents/governance/agent-interview-protocol.md:56
...
|---|---|---|---|
| .agents/governance/agent-interview-protocol.md | 52 | defined here | Defined as Question 4 of the interview protocol documenting collaborative relationships (Before, After, Parallel) between agents. |
| .agents/governance/interview-response-template.md | 65 | used here | Tabular section heading for Question 4 in the interview response template. |
