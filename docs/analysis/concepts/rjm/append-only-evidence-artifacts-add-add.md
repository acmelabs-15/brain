---
package: rjm
name: Append-Only Evidence Artifacts (Add/Add)
slug: append-only-evidence-artifacts-add-add
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 273 | defined here | Primary definition of `Append-Only Evidence Artifacts (Add/Add)` within strategies.md. |
...
## Design notes
An operational technique or artifact (Append-Only Evidence Artifacts (Add/Add)) utilized within the rjm ecosystem to ensure consistency and systematic execution.
