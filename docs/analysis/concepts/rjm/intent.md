...
|---|---|---|---|
| .claude/skills/planner/references/explainers-and-intents.md | 27 | defined here | Primary definition of `Intent` within explainers-and-intents.md. |
...
## Design notes
An operational technique or artifact (Intent) utilized within the rjm ecosystem to ensure consistency and systematic execution.
