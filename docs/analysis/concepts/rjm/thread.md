...
## Definition — verbatim
> "class Thread:" — .claude/skills/panning-for-gold/scripts/inventory.py:40
...
|---|---|---|---|
| .claude/skills/panning-for-gold/scripts/inventory.py | 40 | defined here | Primary definition of `Thread` within inventory.py. |
...
## Design notes
An operational technique or artifact (Thread) utilized within the rjm ecosystem to ensure consistency and systematic execution.
