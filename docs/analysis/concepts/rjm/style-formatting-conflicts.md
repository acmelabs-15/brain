---
package: rjm
name: Style/Formatting Conflicts
slug: style-formatting-conflicts
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 82 | defined here | Primary definition of `Style/Formatting Conflicts` within strategies.md. |
...
## Design notes
An operational technique or artifact (Style/Formatting Conflicts) utilized within the rjm ecosystem to ensure consistency and systematic execution.
