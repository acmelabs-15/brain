---
package: rjm
name: Explainers and Intents
slug: explainers-and-intents
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/references/explainers-and-intents.md | 7 | defined here | Primary definition of `Explainers and Intents` within explainers-and-intents.md. |
...
## Design notes
An operational technique or artifact (Explainers and Intents) utilized within the rjm ecosystem to ensure consistency and systematic execution.
