---
package: rjm
name: Range Vector Window
slug: range-vector-window
kind: technique
...
|---|---|---|---|
| .claude/skills/observability/references/prometheus-recording-rules.md | 93 | defined here | Primary definition of `Range Vector Window` within prometheus-recording-rules.md. |
...
## Design notes
An operational technique or artifact (Range Vector Window) utilized within the rjm ecosystem to ensure consistency and systematic execution.
