...
## Definition — verbatim
(used, not defined)
> "Get-WhatIf -Decision" — .agents/architecture/ADR-038-reflexion-memory-schema.md:186
...
|---|---|---|---|
| .agents/architecture/ADR-038-reflexion-memory-schema.md | 186 | defined here | Proposed PowerShell query cmdlet signature for counterfactual what-if analysis over past episodes |
