---
package: rjm
name: Pressure Stall (PSI)
slug: pressure-stall-psi
kind: technique
...
|---|---|---|---|
| .claude/skills/observability/references/prometheus-recording-rules.md | 67 | defined here | Primary definition of `Pressure Stall (PSI)` within prometheus-recording-rules.md. |
...
## Design notes
An operational technique or artifact (Pressure Stall (PSI)) utilized within the rjm ecosystem to ensure consistency and systematic execution.
