...
> "_BANNED_PATH = re.compile(" — scripts/validation/check_vendor_portability.py:114
...
|---|---|---|---|
| scripts/validation/check_vendor_portability.py | 114 | defined here | Compiled regular expression matching upstream-only paths (`.agents`, `.claude/lib`, and `scripts/`). |
