---
package: rjm
name: Location Directives: Forbidden
slug: location-directives-forbidden
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/resources/diff-format.md | 141 | defined here | Primary definition of `Location Directives: Forbidden` within diff-format.md. |
...
## Design notes
An operational technique or artifact (Location Directives: Forbidden) utilized within the rjm ecosystem to ensure consistency and systematic execution.
