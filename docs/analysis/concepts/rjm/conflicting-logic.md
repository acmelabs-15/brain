...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 63 | defined here | Primary definition of `Conflicting Logic` within strategies.md. |
...
## Design notes
An operational technique or artifact (Conflicting Logic) utilized within the rjm ecosystem to ensure consistency and systematic execution.
