...
|---|---|---|---|
| .agents/architecture/ADR-036-two-source-agent-template-architecture.md | 34 | used here | Cited as a Claude-specific integration feature necessitating intentional prompt divergence in ADR-036. |
...
## Design notes
Serena integration refers to the external integration connecting Claude Code to the Serena persistent memory system, classified as name-only per D-023.
