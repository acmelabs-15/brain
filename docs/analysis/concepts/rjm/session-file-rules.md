---
package: rjm
name: Session File Rules
slug: session-file-rules
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/SKILL.md | 111 | defined here | Primary definition of `Session File Rules` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Session File Rules) utilized within the rjm ecosystem to ensure consistency and systematic execution.
