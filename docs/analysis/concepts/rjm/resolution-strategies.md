...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 1 | defined here | Primary definition of `Resolution Strategies` within strategies.md. |
...
## Design notes
An operational technique or artifact (Resolution Strategies) utilized within the rjm ecosystem to ensure consistency and systematic execution.
