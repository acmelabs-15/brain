...
## Definition — verbatim
> "def load_events(path: Path) -> list[dict]:" — .claude/skills/observability/scripts/query_logs.py:35
...
|---|---|---|---|
| .claude/skills/observability/scripts/query_logs.py | 35 | defined here | Primary definition of `load_events` within query_logs.py. |
...
## Design notes
An operational technique or artifact (load_events) utilized within the rjm ecosystem to ensure consistency and systematic execution.
