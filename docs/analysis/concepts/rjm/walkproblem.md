...
## Definition — verbatim
> "class WalkProblem:" — .claude/skills/orphan-ref-validator/scripts/walking.py:59
...
|---|---|---|---|
| .claude/skills/orphan-ref-validator/scripts/walking.py | 59 | defined here | Primary definition of `WalkProblem` within walking.py. |
...
## Design notes
An operational technique or artifact (WalkProblem) utilized within the rjm ecosystem to ensure consistency and systematic execution.
