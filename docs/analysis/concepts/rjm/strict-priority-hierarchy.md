---
package: rjm
name: strict priority hierarchy
slug: strict-priority-hierarchy
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/SKILL.md | 97 | defined here | Primary definition of `strict priority hierarchy` within SKILL.md. |
...
## Design notes
An operational technique or artifact (strict priority hierarchy) utilized within the rjm ecosystem to ensure consistency and systematic execution.
