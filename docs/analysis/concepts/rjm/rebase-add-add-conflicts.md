---
package: rjm
name: Rebase Add/Add Conflicts
slug: rebase-add-add-conflicts
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 216 | defined here | Primary definition of `Rebase Add/Add Conflicts` within strategies.md. |
...
## Design notes
An operational technique or artifact (Rebase Add/Add Conflicts) utilized within the rjm ecosystem to ensure consistency and systematic execution.
