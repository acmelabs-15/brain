---
package: rjm
name: Numbered Documentation Conflicts (ADR, RFC)
slug: numbered-documentation-conflicts-adr-rfc
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 126 | defined here | Primary definition of `Numbered Documentation Conflicts (ADR, RFC)` within strategies.md. |
...
## Design notes
An operational technique or artifact (Numbered Documentation Conflicts (ADR, RFC)) utilized within the rjm ecosystem to ensure consistency and systematic execution.
