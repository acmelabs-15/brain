...
## Definition — verbatim
> "\"session_id\": {" — .claude/skills/observability/schema.json:29
...
|---|---|---|---|
| .claude/skills/observability/schema.json | 29 | defined here | Primary definition of `session_id` within schema.json. |
...
## Design notes
An operational technique or artifact (session_id) utilized within the rjm ecosystem to ensure consistency and systematic execution.
