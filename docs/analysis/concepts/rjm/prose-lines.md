...
|---|---|---|---|
| scripts/validation/check_vendor_portability.py | 281 | defined here | Helper function identifying line numbers containing prose keyword arguments or diagnostic call parameters. |
