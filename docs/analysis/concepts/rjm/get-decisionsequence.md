---
package: rjm
name: Get-DecisionSequence
slug: get-decisionsequence
kind: name-only
package_phase: none
...
## Definition — verbatim
(used, not defined)
> "Get-DecisionSequence -EpisodeId" — .agents/architecture/ADR-038-reflexion-memory-schema.md:182
...
|---|---|---|---|
| .agents/architecture/ADR-038-reflexion-memory-schema.md | 182 | defined here | Proposed PowerShell query cmdlet signature for fetching the decision sequence of an episode |
