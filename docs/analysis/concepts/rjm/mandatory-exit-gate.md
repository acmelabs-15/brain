---
package: rjm
name: Mandatory Exit Gate
slug: mandatory-exit-gate
kind: technique
...
|---|---|---|---|
| .claude/skills/orphan-ref-validator/SKILL.md | 314 | used here | Referenced and applied in SKILL.md during verification and operational workflows. |
...
## Design notes
An operational technique or artifact (Mandatory Exit Gate) utilized within the rjm ecosystem to ensure consistency and systematic execution.
