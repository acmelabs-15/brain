...
## Definition — verbatim
> "that explicitly calls the token a skill is held to REQ-009 AC-2 and resolves" — .claude/skills/orphan-ref-validator/scripts/counts.py:24
...
|---|---|---|---|
| .claude/skills/orphan-ref-validator/scripts/counts.py | 24 | used here | Referenced and applied in counts.py during verification and operational workflows. |
| .claude/skills/orphan-ref-validator/scripts/patterns.py | 67 | used here | Referenced and applied in patterns.py during verification and operational workflows. |
...
## Design notes
An operational technique or artifact (REQ-009) utilized within the rjm ecosystem to ensure consistency and systematic execution.
