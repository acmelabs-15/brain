...
## Definition — verbatim
> "\"duration_ms\": {" — .claude/skills/observability/schema.json:58
...
|---|---|---|---|
| .claude/skills/observability/schema.json | 58 | defined here | Primary definition of `duration_ms` within schema.json. |
...
## Design notes
An operational technique or artifact (duration_ms) utilized within the rjm ecosystem to ensure consistency and systematic execution.
