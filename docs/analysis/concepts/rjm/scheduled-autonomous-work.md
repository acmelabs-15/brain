---
package: rjm
name: Scheduled Autonomous Work
slug: scheduled-autonomous-work
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/references/agent-architecture-patterns.md | 46 | defined here | Primary definition of `Scheduled Autonomous Work` within agent-architecture-patterns.md. |
...
## Design notes
An operational technique or artifact (Scheduled Autonomous Work) utilized within the rjm ecosystem to ensure consistency and systematic execution.
