...
## Definition — verbatim
(used, not defined)
> "Get-Episodes -Outcome" — .agents/architecture/ADR-038-reflexion-memory-schema.md:181
...
|---|---|---|---|
| .agents/architecture/ADR-038-reflexion-memory-schema.md | 181 | defined here | Proposed PowerShell query cmdlet signature for querying episodes filtered by outcome or date |
