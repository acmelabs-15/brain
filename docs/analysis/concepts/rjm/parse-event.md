...
## Definition — verbatim
> "def parse_event(line: str, line_number: int) -> dict | None:" — .claude/skills/observability/scripts/query_logs.py:20
...
|---|---|---|---|
| .claude/skills/observability/scripts/query_logs.py | 20 | defined here | Primary definition of `parse_event` within query_logs.py. |
...
## Design notes
An operational technique or artifact (parse_event) utilized within the rjm ecosystem to ensure consistency and systematic execution.
