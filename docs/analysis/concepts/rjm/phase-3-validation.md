...
|---|---|---|---|
| .claude/skills/merge-resolver/SKILL.md | 75 | defined here | Primary definition of `Phase 3: Validation` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Phase 3: Validation) utilized within the rjm ecosystem to ensure consistency and systematic execution.
