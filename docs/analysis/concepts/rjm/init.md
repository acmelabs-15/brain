...
## Definition — verbatim
> "init      - Create the workspace directory layout." — .claude/skills/panning-for-gold/scripts/pan.py:5
...
|---|---|---|---|
| .claude/skills/panning-for-gold/scripts/pan.py | 5 | defined here | Primary definition of `init` within pan.py. |
...
## Design notes
An operational technique or artifact (init) utilized within the rjm ecosystem to ensure consistency and systematic execution.
