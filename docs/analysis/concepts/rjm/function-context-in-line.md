---
package: rjm
name: Function Context in @@ Line
slug: function-context-in-line
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/resources/diff-format.md | 79 | defined here | Primary definition of `Function Context in @@ Line` within diff-format.md. |
...
## Design notes
An operational technique or artifact (Function Context in @@ Line) utilized within the rjm ecosystem to ensure consistency and systematic execution.
