---
package: rjm
name: Two-Layer Location Strategy
slug: two-layer-location-strategy
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/resources/diff-format.md | 37 | defined here | Primary definition of `Two-Layer Location Strategy` within diff-format.md. |
...
## Design notes
An operational technique or artifact (Two-Layer Location Strategy) utilized within the rjm ecosystem to ensure consistency and systematic execution.
