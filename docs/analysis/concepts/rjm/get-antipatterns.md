---
package: rjm
name: Get-AntiPatterns
slug: get-antipatterns
kind: name-only
package_phase: none
...
## Definition — verbatim
(used, not defined)
> "Get-AntiPatterns -MaxSuccessRate" — .agents/architecture/ADR-038-reflexion-memory-schema.md:191
...
|---|---|---|---|
| .agents/architecture/ADR-038-reflexion-memory-schema.md | 191 | defined here | Proposed PowerShell query cmdlet signature for identifying failure anti-patterns from the causal graph |
