---
package: rjm
name: Invisible Knowledge
slug: invisible-knowledge
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/resources/plan-format.md | 63 | defined here | Primary definition of `Invisible Knowledge` within plan-format.md. |
...
## Design notes
An operational technique or artifact (Invisible Knowledge) utilized within the rjm ecosystem to ensure consistency and systematic execution.
