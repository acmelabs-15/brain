...
|---|---|---|---|
| .claude/skills/merge-resolver/SKILL.md | 310 | defined here | Primary definition of `Common Failures` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Common Failures) utilized within the rjm ecosystem to ensure consistency and systematic execution.
