---
package: rjm
name: Skill-Negotiation-004: Time Control
slug: skill-negotiation-004-time-control
kind: technique
...
|---|---|---|---|
| .claude/skills/negotiation/references/skills.md | 62 | defined here | Primary definition of `Skill-Negotiation-004: Time Control` within skills.md. |
...
## Design notes
An operational technique or artifact (Skill-Negotiation-004: Time Control) utilized within the rjm ecosystem to ensure consistency and systematic execution.
