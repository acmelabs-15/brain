...
## Definition — verbatim
> "\"session-migration\"," — .claude/skills/orphan-ref-validator/scripts/filters.py:59
...
|---|---|---|---|
| .claude/skills/orphan-ref-validator/scripts/filters.py | 59 | used here | Referenced and applied in filters.py during verification and operational workflows. |
...
## Design notes
An operational technique or artifact (session-migration) utilized within the rjm ecosystem to ensure consistency and systematic execution.
