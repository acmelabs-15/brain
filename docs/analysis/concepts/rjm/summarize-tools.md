...
## Definition — verbatim
> "def summarize_tools(events: list[dict]) -> dict:" — .claude/skills/observability/scripts/query_logs.py:130
...
|---|---|---|---|
| .claude/skills/observability/scripts/query_logs.py | 130 | defined here | Primary definition of `summarize_tools` within query_logs.py. |
...
## Design notes
An operational technique or artifact (summarize_tools) utilized within the rjm ecosystem to ensure consistency and systematic execution.
