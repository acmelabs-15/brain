---
package: rjm
name: Unified Diff Format for Plan Code Changes
slug: unified-diff-format-for-plan-code-changes
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/resources/diff-format.md | 1 | defined here | Primary definition of `Unified Diff Format for Plan Code Changes` within diff-format.md. |
...
## Design notes
An operational technique or artifact (Unified Diff Format for Plan Code Changes) utilized within the rjm ecosystem to ensure consistency and systematic execution.
