...
|---|---|---|---|
| .claude/skills/observability/references/prometheus-recording-rules.md | 110 | defined here | Primary definition of `Onboarding Checklist` within prometheus-recording-rules.md. |
...
## Design notes
An operational technique or artifact (Onboarding Checklist) utilized within the rjm ecosystem to ensure consistency and systematic execution.
