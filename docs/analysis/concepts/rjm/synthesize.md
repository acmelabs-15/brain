...
|---|---|---|---|
| .claude/skills/panning-for-gold/SKILL.md | 10 | defined here | Primary definition of `Synthesize` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Synthesize) utilized within the rjm ecosystem to ensure consistency and systematic execution.
