...
|---|---|---|---|
| .claude/skills/merge-resolver/references/strategies.md | 128 | used here | Referenced and applied in strategies.md during verification and operational workflows. |
| .claude/skills/review/references/architect.md | 99 | defined here | Primary definition of `Architecture Decision Records` within architect.md. |
...
## Design notes
An operational technique or artifact (Architecture Decision Records) utilized within the rjm ecosystem to ensure consistency and systematic execution.
