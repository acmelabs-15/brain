---
package: rjm
name: Phase 2: Analysis and Resolution
slug: phase-2-analysis-and-resolution
kind: technique
...
|---|---|---|---|
| .claude/skills/merge-resolver/SKILL.md | 65 | defined here | Primary definition of `Phase 2: Analysis and Resolution` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Phase 2: Analysis and Resolution) utilized within the rjm ecosystem to ensure consistency and systematic execution.
