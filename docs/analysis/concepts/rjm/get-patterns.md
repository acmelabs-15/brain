...
## Definition — verbatim
(used, not defined)
> "Get-Patterns -MinSuccessRate" — .agents/architecture/ADR-038-reflexion-memory-schema.md:190
...
|---|---|---|---|
| .agents/architecture/ADR-038-reflexion-memory-schema.md | 190 | defined here | Proposed PowerShell query cmdlet signature for extracting successful decision patterns from the causal graph |
