...
|---|---|---|---|
| .claude/skills/planner/resources/plan-format.md | 38 | defined here | Primary definition of `Rejected Alternatives` within plan-format.md. |
| .claude/skills/planner/scripts/planner.py | 56 | defined here | Primary definition of `Rejected Alternatives` within planner.py. |
...
## Design notes
An operational technique or artifact (Rejected Alternatives) utilized within the rjm ecosystem to ensure consistency and systematic execution.
