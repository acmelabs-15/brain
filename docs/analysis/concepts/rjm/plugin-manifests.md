...
|---|---|---|---|
| .claude/skills/merge-resolver/SKILL.md | 146 | defined here | Primary definition of `Plugin Manifests` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Plugin Manifests) utilized within the rjm ecosystem to ensure consistency and systematic execution.
