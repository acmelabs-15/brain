...
> "def was_recorded(" — scripts/validation/portability_git.py:87
...
|---|---|---|---|
| scripts/validation/portability_git.py | 87 | defined here | Function determining whether branch commit history records any prior version of a path. |
