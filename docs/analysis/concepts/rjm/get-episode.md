...
## Definition — verbatim
(used, not defined)
> "Get-Episode -SessionId" — .agents/architecture/ADR-038-reflexion-memory-schema.md:180
...
|---|---|---|---|
| .agents/architecture/ADR-038-reflexion-memory-schema.md | 180 | defined here | Proposed PowerShell query cmdlet signature for fetching a specific session episode record |
