...
## Definition — verbatim
> "(the ``issue-feature-review`` agent, the ``decision-rigor`` review axis, the" — .claude/skills/orphan-ref-validator/scripts/counts.py:12
...
| .claude/skills/review/SKILL.md | 29 | used here | Referenced and applied in SKILL.md during verification and operational workflows. |
...
## Design notes
An operational technique or artifact (decision-rigor) utilized within the rjm ecosystem to ensure consistency and systematic execution.
