---
package: rjm
name: Skill-Negotiation-003: PCP Framing Before Anchoring
slug: skill-negotiation-003-pcp-framing-before-anchoring
kind: technique
...
|---|---|---|---|
| .claude/skills/negotiation/references/skills.md | 45 | defined here | Primary definition of `Skill-Negotiation-003: PCP Framing Before Anchoring` within skills.md. |
...
## Design notes
An operational technique or artifact (Skill-Negotiation-003: PCP Framing Before Anchoring) utilized within the rjm ecosystem to ensure consistency and systematic execution.
