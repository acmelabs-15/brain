---
package: rjm
name: Planning Phase as OODA
slug: planning-phase-as-ooda
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/references/strategy-ooda-loop.md | 30 | defined here | Primary definition of `Planning Phase as OODA` within strategy-ooda-loop.md. |
...
## Design notes
An operational technique or artifact (Planning Phase as OODA) utilized within the rjm ecosystem to ensure consistency and systematic execution.
