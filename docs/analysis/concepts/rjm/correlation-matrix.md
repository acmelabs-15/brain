...
|---|---|---|---|
| .claude/skills/observability/references/three-pillars-reference.md | 65 | defined here | Primary definition of `Correlation Matrix` within three-pillars-reference.md. |
...
## Design notes
An operational technique or artifact (Correlation Matrix) utilized within the rjm ecosystem to ensure consistency and systematic execution.
