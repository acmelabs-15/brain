...
|---|---|---|---|
| .agents/analysis/adr-045-inventory-audit.md | 1 | defined here | Title of empirical audit report verifying artifact classifications across the repository. |
...
## Design notes
Document title of an architectural feasibility analysis audit, not an independent lifecycle concept.
