...
|---|---|---|---|
| .claude/skills/negotiation/references/skills.md | 62 | defined here | Primary definition of `Time Control` within skills.md. |
...
## Design notes
An operational technique or artifact (Time Control) utilized within the rjm ecosystem to ensure consistency and systematic execution.
