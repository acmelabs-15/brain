...
|---|---|---|---|
| .claude/skills/negotiation/SKILL.md | 50 | defined here | Primary definition of `Phase 3: Design` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Phase 3: Design) utilized within the rjm ecosystem to ensure consistency and systematic execution.
