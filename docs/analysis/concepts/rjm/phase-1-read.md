...
|---|---|---|---|
| .claude/skills/negotiation/SKILL.md | 39 | defined here | Primary definition of `Phase 1: Read` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Phase 1: Read) utilized within the rjm ecosystem to ensure consistency and systematic execution.
