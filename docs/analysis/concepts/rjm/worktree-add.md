...
> "_WORKTREE_ADD = re.compile(" — scripts/validation/check_worktree_recipes.py:110
...
|---|---|---|---|
| scripts/validation/check_worktree_recipes.py | 110 | defined here | Regular expression detecting git worktree add command invocations and capturing remaining argument tokens. |
