...
|---|---|---|---|
| .agents/architecture/ADR-056-skill-output-format-standardization.md | 48 | defined here | Top-level property in standard envelope containing structured payload on success. |
...
## Design notes
A top-level payload field identifier in the standard output envelope holding structured return data upon successful execution per D-023.
