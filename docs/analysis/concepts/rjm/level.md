...
## Definition — verbatim
> "\"level\": {" — .claude/skills/observability/schema.json:41
...
|---|---|---|---|
| .claude/skills/observability/schema.json | 41 | defined here | Primary definition of `level` within schema.json. |
...
## Design notes
An operational technique or artifact (level) utilized within the rjm ecosystem to ensure consistency and systematic execution.
