---
package: rjm
name: Pre-Flight Checkpoints
slug: pre-flight-checkpoints
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/references/hybrid-memory-architecture.md | 52 | defined here | Primary definition of `Pre-Flight Checkpoints` within hybrid-memory-architecture.md. |
...
## Design notes
An operational technique or artifact (Pre-Flight Checkpoints) utilized within the rjm ecosystem to ensure consistency and systematic execution.
