...
|---|---|---|---|
| .claude/skills/panning-for-gold/references/gold-found-template.md | 9 | defined here | Primary definition of `High-Signal` within gold-found-template.md. |
| .claude/skills/panning-for-gold/scripts/synthesis.py | 28 | used here | Referenced and applied in synthesis.py during verification and operational workflows. |
| .claude/skills/panning-for-gold/SKILL.md | 91 | used here | Referenced and applied in SKILL.md during verification and operational workflows. |
| .claude/skills/prose-self-check/SKILL.md | 65 | defined here | Primary definition of `High-Signal` within SKILL.md. |
...
## Design notes
An operational technique or artifact (High-Signal) utilized within the rjm ecosystem to ensure consistency and systematic execution.
