...
## Design notes
Legacy PowerShell script cmdlet identifier for fetching pull request context, classified in ADR-031 as a candidate for direct gh CLI routing, not an operational lifecycle concept.
