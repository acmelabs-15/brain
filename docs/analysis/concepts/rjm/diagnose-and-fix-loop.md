...
## Definition — verbatim
> "### Step 5: Diagnose and Fix Loop" — .claude/skills/pipeline-validator/SKILL.md:264
...
|---|---|---|---|
| .claude/skills/pipeline-validator/SKILL.md | 264 | defined here | Primary definition of `Diagnose and Fix Loop` within SKILL.md. |
...
## Design notes
An operational technique or artifact (Diagnose and Fix Loop) utilized within the rjm ecosystem to ensure consistency and systematic execution.
