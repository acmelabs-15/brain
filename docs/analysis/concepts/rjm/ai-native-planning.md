---
package: rjm
name: AI-Native Planning
slug: ai-native-planning
kind: technique
...
|---|---|---|---|
| .claude/skills/planner/references/design-pit-of-success.md | 47 | defined here | Primary definition of `AI-Native Planning` within design-pit-of-success.md. |
...
## Design notes
An operational technique or artifact (AI-Native Planning) utilized within the rjm ecosystem to ensure consistency and systematic execution.
