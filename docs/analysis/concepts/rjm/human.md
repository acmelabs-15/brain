...
|---|---|---|---|
| .agents/architecture/ADR-056-skill-output-format-standardization.md | 49 | defined here | Output format enum option directing scripts to print human-readable console summaries. |
| .agents/architecture/ADR-103-skill-output-python-contract-correction.md | 94 | defined here | Standardized lowercase format argument option in Python skill scripts. |
...
## Design notes
An output format mode identifier directing scripts to render user-friendly terminal summaries per D-023.
