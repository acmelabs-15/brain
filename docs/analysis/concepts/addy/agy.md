...
> "Antigravity CLI" — docs/antigravity-setup.md:1

## Where used
| File | Line | Role | How it is used |
|---|---|---|---|
| docs/antigravity-setup.md | 1 | defines | Binary command-line name for the Antigravity CLI environment |
...
## Design notes
agy is the executable binary name for the Antigravity CLI tool, representing a CLI invocation command rather than a lifecycle concept.
