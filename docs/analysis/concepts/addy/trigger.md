...
|---|---|---|---|
| evals/cases/api-and-interface-design.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/browser-testing-with-devtools.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/ci-cd-and-automation.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/code-review-and-quality.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/code-simplification.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/constraint-driven-development.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/context-engineering.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/debugging-and-error-recovery.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/deprecation-and-migration.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/documentation-and-adrs.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/doubt-driven-development.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/frontend-ui-engineering.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/git-workflow-and-versioning.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/idea-refine.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/incremental-implementation.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/interview-me.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/observability-and-instrumentation.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/performance-optimization.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/planning-and-task-breakdown.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/security-and-hardening.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/shipping-and-launch.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/source-driven-development.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/spec-driven-development.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/test-driven-development.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/cases/using-agent-skills.json | 3 | defined here | JSON object key grouping trigger evaluation cases. |
| evals/fixtures/frontend-ui-engineering/design-system.md | 7 | used here | Used to describe the UI element that triggers opening a menu component. |
| evals/README.md | 47 | used here | Schema example showing the trigger configuration block in eval case format. |
...
## Design notes
trigger is a schema property in evaluation test suites grouping positive and negative routing tests, as well as a generic UI element label, rather than an independent software engineering lifecycle concept.
