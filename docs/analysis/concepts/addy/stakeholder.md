...
|---|---|---|---|
| evals/fixtures/debugging-and-error-recovery/time-pressure.md | 3 | references | Mentions a project stakeholder demanding immediate unverified code edits during an incident. |
...
## Design notes
Generic human role mentioned in an evaluation fixture scenario, not a lifecycle methodology concept.
