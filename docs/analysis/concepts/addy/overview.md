...
> "## Overview" — docs/skill-anatomy.md:44
...
|---|---|---|---|
| docs/skill-anatomy.md | 44 | defined here | Heading for the introductory overview section of a SKILL.md. |
| external/api-and-interface-design.md | 10 | defined here | HTML anatomy list item for the overview section. |
| external/browser-testing-with-devtools.md | 10 | defined here | HTML anatomy list item for the overview section. |
| external/ci-cd-and-automation.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/code-review-and-quality.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/code-simplification.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/context-engineering.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/debugging-and-error-recovery.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/deprecation-and-migration.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/documentation-and-adrs.md | 10 | defined here | HTML anatomy list item for the overview section. |
| external/doubt-driven-development.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/frontend-ui-engineering.md | 10 | defined here | HTML anatomy list item for the overview section. |
| external/git-workflow-and-versioning.md | 10 | defined here | HTML anatomy list item for the overview section. |
| external/idea-refine.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/interview-me.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/observability-and-instrumentation.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/performance-optimization.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/planning-and-task-breakdown.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/security-and-hardening.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/shipping-and-launch.md | 10 | defined here | HTML anatomy list item for the overview section. |
| external/source-driven-development.md | 10 | defined here | HTML anatomy list item for the overview section. |
| external/spec-driven-development.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/test-driven-development.md | 10 | used here | HTML anatomy list item for the overview section. |
| external/using-agent-skills.md | 10 | used here | HTML anatomy list item for the overview section. |
...
defects: [doc-drift, internal-contradiction] across docs/skill-anatomy.md and external documentation cards

## Design notes
Overview is a structural markdown heading in skill definitions summarizing what a skill does rather than an independent lifecycle concept.
