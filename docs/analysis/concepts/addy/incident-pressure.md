...
|---|---|---|---|
| evals/fixtures/debugging-and-error-recovery/time-pressure.md | 1 | defines | Document heading for an evaluation scenario testing debugging discipline under production fire. |
