...
|---|---|---|---|
| scripts/validate-versions-test.js | 12 | used here | Included in manifestPaths array to test Claude plugin marketplace entry version |
| scripts/validate-versions.js | 12 | used here | Included in manifestPaths array to validate marketplace catalog version |
...
## Design notes
Catalog metadata file path for Claude plugin marketplace distribution; not a development lifecycle concept.
