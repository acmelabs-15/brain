...
|---|---|---|---|
| evals/cases/api-and-interface-design.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/browser-testing-with-devtools.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/ci-cd-and-automation.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/code-review-and-quality.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/code-simplification.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/constraint-driven-development.json | 26 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/context-engineering.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/debugging-and-error-recovery.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/deprecation-and-migration.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/documentation-and-adrs.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/doubt-driven-development.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/frontend-ui-engineering.json | 26 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/git-workflow-and-versioning.json | 22 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/idea-refine.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/incremental-implementation.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/interview-me.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/observability-and-instrumentation.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/performance-optimization.json | 26 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/planning-and-task-breakdown.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/security-and-hardening.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/shipping-and-launch.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/source-driven-development.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/spec-driven-development.json | 26 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/test-driven-development.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/cases/using-agent-skills.json | 18 | defined here | JSON array of negative trigger evaluation cases. |
| evals/README.md | 51 | used here | Schema example showing the negative trigger case array. |
...
## Design notes
negative is a JSON schema array property in evaluation test cases containing prompts that should not trigger the target skill rather than a software development lifecycle concept.
