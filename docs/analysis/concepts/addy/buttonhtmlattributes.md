...
|---|---|---|---|
| evals/fixtures/frontend-ui-engineering/Button.tsx | 3 | used here | TypeScript interface imported from React to type standard HTML button properties. |
...
## Design notes
Third-party TypeScript interface identifier for HTML button attributes rather than a lifecycle concept.
