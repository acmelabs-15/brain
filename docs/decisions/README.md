...
| [ADR-007-no-transition-states.md](ADR-007-no-transition-states.md) | A retired skill is deleted in the commit that lands its replacement, every live reference retargeted; the six stubs and two wrappers deleted (40 skills ship); supersedes ADR-006 D4's stub clause and PRD-002 requirement 9's until-Part-6 clause | accepted |
