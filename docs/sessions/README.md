...
<!-- sessions:start -->
- [SES-001 · 2026-08-31 07:09 · The docs system — PRD-001, PLAN-001, the decisions and the analyses](SES-001-docs-system.md) — in progress · PLAN-001 · part 1 — Keep this repo's docs system — PRD-001, PLAN-001, ADR-001/002, ANA-001/002 and their READMEs — the copy of record while PLAN-001's code lands in acmelabs-15/sessions: every commit here gets its entry, and every claim a later commit makes stale is corrected in the same step.
<!-- sessions:end -->
