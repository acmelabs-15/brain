...
## Scope & Objectives
Phase 1 — Inventory for units inv-addy-9, inv-addy-10, inv-addy-11, inv-addy-12, inv-addy-13, inv-addy-14, inv-addy-15, inv-addy-16, inv-addy-17, inv-addy-18, inv-addy-19, inv-addy-20, dispatched by session 004. Purpose: exploration/analysis artefacts for the brain lifecycle synthesis. Audience: the next session of this project, which reads only files.

## Requirements
- Every unit in inv-addy-9, inv-addy-10, inv-addy-11, inv-addy-12, inv-addy-13, inv-addy-14, inv-addy-15, inv-addy-16, inv-addy-17, inv-addy-18, inv-addy-19, inv-addy-20 produces the deliverables named by `unit-facts.ts`, filled from templates/inventory-entry.md, obeying METHOD.md R1–R11.
...
## Acceptance Criteria
- Every unit in inv-addy-9, inv-addy-10, inv-addy-11, inv-addy-12, inv-addy-13, inv-addy-14, inv-addy-15, inv-addy-16, inv-addy-17, inv-addy-18, inv-addy-19, inv-addy-20: all deliverables exist, coverage.ts zero failures, quote-check.ts zero FAIL.
