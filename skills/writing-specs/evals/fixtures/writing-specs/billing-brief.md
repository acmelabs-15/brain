...
rules, customer-facing usage visibility, and regional tax behavior. Produce the requirements document and surface these decisions; do not implement them by
assumption.
