...
For the tracker the Spec axis reads the originating issue from, use the repo's own `docs/agents/issue-tracker.md` if it has one, otherwise `~/.claude/references/issue-tracker.md`.
