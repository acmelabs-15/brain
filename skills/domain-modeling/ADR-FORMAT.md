...
ADRs live where the project keeps them — the root `CLAUDE.md` or the docs README says, and an existing ADR shows the filename pattern to continue (env-setup: `docs/decisions/ADR-NNN-kebab-title.md`). With no convention, the default is `docs/adr/` with sequential numbering: `0001-slug.md`, `0002-slug.md`, etc.
...
Scan the project's ADR directory for the highest existing number and increment by one.
