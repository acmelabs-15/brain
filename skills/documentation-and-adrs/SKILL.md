...
- **Location and format** — e.g. `docs/adr/*.md`, `docs/decisions/ADR-NNN-title.md` (env-setup), `Documentation/Decisions/*.rst`, a MADR layout, or an `adr-tools` setup. Match the existing directory, file extension, and markup (Markdown vs reStructuredText).
