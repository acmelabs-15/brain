...
Run a stateful interview (call the Skill tool for "interview-me", artifact mode) whose only output is **workflow** specs. Use its discipline (relentless, one question at a time, a recommended answer attached to each) aimed at the vocabulary and goal below. Create, edit, and delete specs as the grilling resolves things.
