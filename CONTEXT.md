...
The words of the record this repo keeps — session, entry, gate, plan part, the acts start · log ·
close — are defined once, in [skills/session/CONTEXT.md](./skills/session/CONTEXT.md), the plugin's
own glossary (ADR-004). This repo's `docs/` uses them as defined there.
